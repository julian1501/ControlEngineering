/*
 * Reference_model_Control_Engineering_4_private.h
 *
...
#ifndef RTW_HEADER_Reference_model_Control_Engineering_4_private_h_
#define RTW_HEADER_Reference_model_Control_Engineering_4_private_h_
#include "rtwtypes.h"
