###########################################################################
## Makefile generated for component 'Reference_model_Control_Engineering_new'. 
## 
## Makefile     : Reference_model_Control_Engineering_new.mk
## Generated on : Tue Apr 15 10:17:09 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Reference_model_Control_Engineering_new.elf
...
PRODUCT_NAME              = Reference_model_Control_Engineering_new
MAKEFILE                  = Reference_model_Control_Engineering_new.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Reference_model_Control_Engineering_new.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Reference_model_Control_Engineering_new_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=Reference_model_Control_Engineering_new -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = rt_matrx.c.o rt_printf.c.o Reference_model_Control_Engineering_new.c.o Reference_model_Control_Engineering_new_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o ddoubleint.c.o dleadlag.c.o dlowpass2.c.o dnotch.c.o ec_Ebox.c.o ec_Supervisor.c.o ref3b.c.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
%.c.o : $(START_DIR)/Reference_model_Control_Engineering_new_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Reference_model_Control_Engineering_new_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Reference_model_Control_Engineering_new_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Reference_model_Control_Engineering_new_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Reference_model_Control_Engineering_new.c.o : $(START_DIR)/Reference_model_Control_Engineering_new_ert_rtw/Reference_model_Control_Engineering_new.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Reference_model_Control_Engineering_new_data.c.o : $(START_DIR)/Reference_model_Control_Engineering_new_ert_rtw/Reference_model_Control_Engineering_new_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/Reference_model_Control_Engineering_new_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/Reference_model_Control_Engineering_new_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/Reference_model_Control_Engineering_new_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
