/*
 * Reference_model_Control_Engineering_new.h
 *
...
#ifndef RTW_HEADER_Reference_model_Control_Engineering_new_h_
#define RTW_HEADER_Reference_model_Control_Engineering_new_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#include <stdlib.h>
#include <float.h>
#ifndef Reference_model_Control_Engineering_new_COMMON_INCLUDES_
#define Reference_model_Control_Engineering_new_COMMON_INCLUDES_
#include <stdio.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#include "dt_info.h"
#include "ext_work.h"
#endif            /* Reference_model_Control_Engineering_new_COMMON_INCLUDES_ */

#include "Reference_model_Control_Engineering_new_types.h"
...
typedef struct {
  ...
  real_T Dctdoubleintegrator4;         /* '<S7>/Dctdoubleintegrator4' */
...
typedef struct {
  ...
  real_T Dctdoubleintegrator4_RWORK[4];/* '<S7>/Dctdoubleintegrator4' */
...
struct P_Reference_model_Control_Engineering_new_T_ {
  ...
  real_T Gain1_Gain;                   /* Expression: 1e-3
                                        ...
                                        */
  real_T Ka_Gain;                      /* Expression: -0.00030
                                        * Referenced by: '<S1>/Ka'
                                        */
  real_T Kfc_Gain;                     /* Expression: -0.0361
...
struct tag_RTM_Reference_model_Control_Engineering_new_T {
...
extern P_Reference_model_Control_Engineering_new_T
  Reference_model_Control_Engineering_new_P;

/* Block signals (default storage) */
extern B_Reference_model_Control_Engineering_new_T
  Reference_model_Control_Engineering_new_B;

/* Block states (default storage) */
extern DW_Reference_model_Control_Engineering_new_T
  Reference_model_Control_Engineering_new_DW;

/* External function called from main */
extern void Reference_model_Control_Engineering_new_SetEventsForThisBaseStep
  (boolean_T *eventFlags);

/* Model entry point functions */
extern void Reference_model_Control_Engineering_new_SetEventsForThisBaseStep
  (boolean_T *eventFlags);
extern void Reference_model_Control_Engineering_new_initialize(void);
extern void Reference_model_Control_Engineering_new_step0(void);
extern void Reference_model_Control_Engineering_new_step2(void);
extern void Reference_model_Control_Engineering_new_step(int_T tid);
extern void Reference_model_Control_Engineering_new_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Reference_model_Control_Engineering_new_T *const
 ...
 *
 * '<Root>' : 'Reference_model_Control_Engineering_new'
 * '<S1>'   : 'Reference_model_Control_Engineering_new/Feedforward'
 * '<S2>'   : 'Reference_model_Control_Engineering_new/Fourth Order Motion System'
 * '<S3>'   : 'Reference_model_Control_Engineering_new/Measurement Block'
 * '<S4>'   : 'Reference_model_Control_Engineering_new/Real-time scope'
 * '<S5>'   : 'Reference_model_Control_Engineering_new/Ref power'
 * '<S6>'   : 'Reference_model_Control_Engineering_new/Subsystem'
 * '<S7>'   : 'Reference_model_Control_Engineering_new/T10-2 High gain - similar 3 Hz notch + 60 Notch wide (second order)_ 53.68 dB gain'
 * '<S8>'   : 'Reference_model_Control_Engineering_new/Fourth Order Motion System/Ethercat E-box'
 * '<S9>'   : 'Reference_model_Control_Engineering_new/Fourth Order Motion System/Ethercat Supervisor'
 * '<S10>'  : 'Reference_model_Control_Engineering_new/Measurement Block/SPERTE_measurement_function'
 */
#endif               /* RTW_HEADER_Reference_model_Control_Engineering_new_h_ */
