...
#ifndef RTW_HEADER_FinalAssingmentModel_h_
#define RTW_HEADER_FinalAssingmentModel_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#include <stdlib.h>
#include <float.h>
#ifndef FinalAssingmentModel_COMMON_INCLUDES_
#define FinalAssingmentModel_COMMON_INCLUDES_
#include <stdio.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#include "dt_info.h"
#include "ext_work.h"
#endif                               /* FinalAssingmentModel_COMMON_INCLUDES_ */

#include "FinalAssingmentModel_types.h"
...
} DW_FinalAssingmentModel_T;

/* Parameters (default storage) */
struct P_FinalAssingmentModel_T_ {
...
struct tag_RTM_FinalAssingmentModel_T {
...
extern P_FinalAssingmentModel_T FinalAssingmentModel_P;

/* Block signals (default storage) */
extern B_FinalAssingmentModel_T FinalAssingmentModel_B;

/* Block states (default storage) */
extern DW_FinalAssingmentModel_T FinalAssingmentModel_DW;

/* External function called from main */
extern void FinalAssingmentModel_SetEventsForThisBaseStep(boolean_T *eventFlags);

/* Model entry point functions */
extern void FinalAssingmentModel_SetEventsForThisBaseStep(boolean_T *eventFlags);
extern void FinalAssingmentModel_initialize(void);
extern void FinalAssingmentModel_step0(void);
extern void FinalAssingmentModel_step2(void);
extern void FinalAssingmentModel_step(int_T tid);
extern void FinalAssingmentModel_terminate(void);

/* Real-time Model object */
extern RT_MODEL_FinalAssingmentModel_T *const FinalAssingmentModel_M;
 ...
 *
 * '<Root>' : 'FinalAssingmentModel'
 * '<S1>'   : 'FinalAssingmentModel/Controller (motor side)'
 * '<S2>'   : 'FinalAssingmentModel/Fourth Order Motion System'
 * '<S3>'   : 'FinalAssingmentModel/Measurement Block'
 * '<S4>'   : 'FinalAssingmentModel/Real-time scope'
 * '<S5>'   : 'FinalAssingmentModel/Ref power'
 * '<S6>'   : 'FinalAssingmentModel/Subsystem'
 * '<S7>'   : 'FinalAssingmentModel/Fourth Order Motion System/Ethercat E-box'
 * '<S8>'   : 'FinalAssingmentModel/Fourth Order Motion System/Ethercat Supervisor'
 * '<S9>'   : 'FinalAssingmentModel/Measurement Block/SPERTE_measurement_function'
 */
#endif                                 /* RTW_HEADER_FinalAssingmentModel_h_ */
