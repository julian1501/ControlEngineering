...
void FinalAssingmentModel_step0(void)  /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (FinalAssingmentModel_B.Noise > FinalAssingmentModel_P.Saturation_UpperSat)
  {
    FinalAssingmentModel_B.Quantizer1 =
      FinalAssingmentModel_P.Saturation_UpperSat;
  } else if (FinalAssingmentModel_B.Noise <
             FinalAssingmentModel_P.Saturation_LowerSat) {
    FinalAssingmentModel_B.Quantizer1 =
      FinalAssingmentModel_P.Saturation_LowerSat;
  } else {
    FinalAssingmentModel_B.Quantizer1 = FinalAssingmentModel_B.Noise;
  }
...
void FinalAssingmentModel_initialize(void)
{
  ...
  rtmSetTFinal(FinalAssingmentModel_M, 120.0);
  FinalAssingmentModel_M->Timing.stepSize0 = 0.00025;
  FinalAssingmentModel_M->Timing.stepSize1 = 0.00025;

  /* External mode info */
  FinalAssingmentModel_M->Sizes.checksums[0] = (1886699691U);
  FinalAssingmentModel_M->Sizes.checksums[1] = (2732263417U);
  FinalAssingmentModel_M->Sizes.checksums[2] = (1407495660U);
  FinalAssingmentModel_M->Sizes.checksums[3] = (718364197U);
