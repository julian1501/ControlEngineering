...
struct P_Reference_model_Control_Engineering_T_ {
  ...
  real_T Dctleadlag1_P3;               /* Expression: 0.001
                                        * Referenced by: '<S1>/Dctleadlag1'
                                        */
  real_T Ka_Gain;                      /* Expression: 0.0001
                                        * Referenced by: '<S2>/Ka'
                                        */
  real_T Kfc_Gain;                     /* Expression: 0
                                        * Referenced by: '<S2>/Kfc'
                                        */
  real_T Kv_Gain;                      /* Expression: 0.02
                                        * Referenced by: '<S2>/Kv'
                                        */
 ...
 * '<S1>'   : 'Reference_model_Control_Engineering/Controller (motor side)'
 * '<S2>'   : 'Reference_model_Control_Engineering/Feedforward'
 * '<S3>'   : 'Reference_model_Control_Engineering/Fourth Order Motion System'
 * '<S4>'   : 'Reference_model_Control_Engineering/MATLAB Function'
 * '<S5>'   : 'Reference_model_Control_Engineering/Measurement Block'
 * '<S6>'   : 'Reference_model_Control_Engineering/Real-time scope'
 * '<S7>'   : 'Reference_model_Control_Engineering/Ref power'
 * '<S8>'   : 'Reference_model_Control_Engineering/Subsystem'
 * '<S9>'   : 'Reference_model_Control_Engineering/Fourth Order Motion System/Ethercat E-box'
 * '<S10>'  : 'Reference_model_Control_Engineering/Fourth Order Motion System/Ethercat Supervisor'
 * '<S11>'  : 'Reference_model_Control_Engineering/Measurement Block/SPERTE_measurement_function'
 */
