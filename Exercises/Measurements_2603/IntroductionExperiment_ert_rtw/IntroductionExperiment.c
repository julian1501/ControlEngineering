...
void IntroductionExperiment_initialize(void)
{
  ...
  /* External mode info */
  IntroductionExperiment_M->Sizes.checksums[0] = (1618730942U);
  IntroductionExperiment_M->Sizes.checksums[1] = (3033904767U);
  IntroductionExperiment_M->Sizes.checksums[2] = (395205111U);
  IntroductionExperiment_M->Sizes.checksums[3] = (11957150U);
